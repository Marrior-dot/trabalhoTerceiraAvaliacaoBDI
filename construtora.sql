CREATE TABLE Engenheiro(
    ...
    CONSTRAINT PK_ENGENHEIRO PRIMARY KEY(NUMERO_CREA, REGISTRO_IMOVEL)
);
...
CREATE TABLE Projeto(
    REGISTRO_MOVEL_OBRA INT NOT NULL,
    ID_ARQUITETO INT NOT NULL,
    NUMERO_CREA_ENGENHEIRO INT NOT NULL,
    NOME VARCHAR(40) NOT NULL,
    AREA_OCUPADA FLOAT NOT NULL,
    ID_PROJETO INT NOT NULL,
    CONSTRAINT PK_PROJETO PRIMARY KEY(ID_ARQUITETO, NUMERO_CREA_ENGENHEIRO, ID_ARQUITETO, REGISTRO_IMOVEL_OBRA)
);
